...
class AdminModel extends Query
{
    ...
    {
        $sql = "SELECT * FROM carpetas WHERE id_usuario = $id_usuario AND estado = 1 AND id != 1 ORDER BY id DESC LIMIT 10";
    ...
    {
        $sql = "SELECT * FROM archivos WHERE id_usuario = $id_usuario AND estado = 1  ORDER BY id DESC LIMIT 14";
        return $this->selectAll($sql);
    }
