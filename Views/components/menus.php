...
<div class="content-menu content-menu-right">
    <ul class="list-unstyled">
        ...
        <li><a href="<?php echo BASE_URL . 'admin' ?>" class="<?php echo ($data['active'] == 'Recientes' ? 'active' : '') ?>">Recientes</a></li>
        <li><a href="#">My Devices</a></li>
        <li><a href="#">Important</a></li>
        <li><a href="<?php echo BASE_URL . 'archivos/recicle' ?>" class="<?php echo ($data['active'] == 'Eliminar' ? 'active' : '') ?>">Eliminar</a></li>
        <li class="divider"></li>
