                        ...
                        <div class="card file-manager-group">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div class="file-manager-group-info flex-fill">
                                    <a href="#" data-id="<?php echo $carpeta['id'] ?>" class="file-manager-group-title carpetas"><?php echo $carpeta['nombre'] ?></a>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="file-manager-recent-<?php echo $archivo['id'] ?>">
                                        <li><a class="dropdown-item compartir" data-id="<?php echo $archivo['id'] ?>" href="#">Compartir</a></li>
