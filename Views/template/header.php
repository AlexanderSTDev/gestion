...
<body>
    <div class="app align-content-stretch d-flex flex-wrap">
        <div class="app-sidebar">
            <div class="logo">
                <a href="#" class="logo-icon"><span class="logo-text">DRIVE</span></a>
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="<?php echo ($data['menu'] == 'usuarios') ? 'active-page' : '' ?>">
                        <a href="<?php echo BASE_URL . 'usuarios' ?>" class="<?php echo ($data['menu'] == 'usuarios') ? 'active' : '' ?>"><i class="material-icons-two-tone">dashboard</i>Usuarios</a>
                    </li>
        ...
        <div class="app-container">
            <div class="search">
                <form>
                    <input id="inputBuscar" class="form-control" type="text" placeholder="Buscar..." aria-label="Search">
                                        ...
                                        <div class="notifications-dropdown-list">
                                            <a href="<?php echo BASE_URL . 'usuarios/profile' ?>">
                                                <div class="notifications-dropdown-item">
                                                    ...
                                                    <div class="notifications-dropdown-item-text">
                                                        <p class="bold-notifications-text">Perfil</p>
                                                    </div>
                                                </div>
                                            </a>
                                            <a href="<?php echo BASE_URL . 'usuarios/salir' ?>">
                                                <div class="notifications-dropdown-item">
                                                    ...
                                                    <div class="notifications-dropdown-item-text">
                                                        <p class="bold-notifications-text">Salir</p>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
